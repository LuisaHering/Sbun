...
<?php 
	if(isset($_POST['update'])){ 
		$connection = mysqli_connect("localhost","root",""); 
		$db = mysqli_select_db($connection,"sbun"); 
		$query = "update books set book_name = '$_POST[book_name]',author_id = $_POST[author_id],cat_id = $_POST[cat_id],book_quantity = $_POST[book_quantity] where book_no = $_GET[bn]"; 
		$query_run = mysqli_query($connection,$query); 
