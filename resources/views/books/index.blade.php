        ...
        <div class="w-full grid grid-cols-12 gap-4">
            ...
            <div class="col-span-6 flex items-end">
                <form class="w-full flex gap-2">
                    <div class="shrink-0 text-gray-800 dark:text-gray-200 leading-tight pt-1 flex items-center">
                        @lang('Search')
                    </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
                    src="https://i.postimg.cc/w3Kxz5z0/Design-sem-nome-1.png" alt="">
                    ...
                    <div class="w-full">
                        ...
                        <div
                            @class([
                                ...
                                'mb-3 mt-2 font-normal text-gray-700 dark:text-gray-400 overflow-y-auto h-32',
                            ])
                        >{!! $book->sinopsis !!}</div>
                    </div>
                </div>
